...
#define MSG_SD_INSERTED                     _UxGT("Karte erkannt")
#define MSG_SD_REMOVED                      _UxGT("Karte entfernt")
#define MSG_LCD_ENDSTOPS                    _UxGT("Endstopp") // Max length 8 characters
#define MSG_LCD_SOFT_ENDSTOPS               _UxGT("Soft-Endstopp")
#define MSG_MAIN                            _UxGT("Menü")
#define MSG_AUTOSTART                       _UxGT("Autostart")
#define MSG_DISABLE_STEPPERS                _UxGT("Motoren aus") // M84
#define MSG_DEBUG_MENU                      _UxGT("Debug-Menü")
#define MSG_PROGRESS_BAR_TEST               _UxGT("Status-Test")
#define MSG_AUTO_HOME                       _UxGT("Home XYZ") // G28
#define MSG_AUTO_HOME_X                     _UxGT("Home X")
#define MSG_AUTO_HOME_Y                     _UxGT("Home Y")
#define MSG_AUTO_HOME_Z                     _UxGT("Home Z")
#define MSG_TMC_Z_CALIBRATION               _UxGT("Kalibr. Z")
...
#define MSG_PREHEAT_1_ALL                   _UxGT("Vorw. PLA")
...
#define MSG_PREHEAT_2                       _UxGT("Vorw. ABS")
#define MSG_PREHEAT_2_N                     _UxGT("Vorw. ABS ")
#define MSG_PREHEAT_2_ALL                   _UxGT("Vorw. ABS")
...
#define MSG_COOLDOWN                        _UxGT("Kühlen")
#define MSG_SWITCH_PS_ON                    _UxGT("Strom ein")
#define MSG_SWITCH_PS_OFF                   _UxGT("Strom aus")
...
#define MSG_LEVEL_BED                       _UxGT("nivellieren")
#define MSG_LEVEL_CORNERS                   _UxGT("Ecken nivellieren")
#define MSG_NEXT_CORNER                     _UxGT("Nächste")
...
#define MSG_UBL_LEVEL_BED                   _UxGT("UBL")
#define MSG_UBL_MANUAL_MESH                 _UxGT("Netz erst.")
...
#define MSG_UBL_MOVING_TO_NEXT              _UxGT("Nächster")
#define MSG_UBL_ACTIVATE_MESH               _UxGT("aktivieren")
#define MSG_UBL_DEACTIVATE_MESH             _UxGT("deaktivieren")
#define MSG_UBL_SET_BED_TEMP                _UxGT("Betttemp.")
#define MSG_UBL_CUSTOM_BED_TEMP             MSG_UBL_SET_BED_TEMP
#define MSG_UBL_SET_HOTEND_TEMP             _UxGT("Düsen-Temp.")
#define MSG_UBL_CUSTOM_HOTEND_TEMP          MSG_UBL_SET_HOTEND_TEMP
#define MSG_UBL_MESH_EDIT                   _UxGT("Netz bearbeiten")
#define MSG_UBL_EDIT_CUSTOM_MESH            _UxGT("Eigenes Netz bearb.")
#define MSG_UBL_FINE_TUNE_MESH              _UxGT("Fein")
#define MSG_UBL_DONE_EDITING_MESH           _UxGT("Bearb. beendet")
#define MSG_UBL_BUILD_CUSTOM_MESH           _UxGT("Eigenes Netz erst.")
#define MSG_UBL_BUILD_MESH_MENU             _UxGT("Netz erst.")
#define MSG_UBL_BUILD_PLA_MESH              _UxGT("Netz erst. PLA")
#define MSG_UBL_BUILD_ABS_MESH              _UxGT("Netz erst. ABS")
#define MSG_UBL_BUILD_COLD_MESH             _UxGT("Netz erst. kalt")
#define MSG_UBL_MESH_HEIGHT_ADJUST          _UxGT("Netzhöhe einst.")
#define MSG_UBL_MESH_HEIGHT_AMOUNT          _UxGT("Höhe")
#define MSG_UBL_VALIDATE_MESH_MENU          _UxGT("Netz valid.")
#define MSG_UBL_VALIDATE_PLA_MESH           _UxGT("Netz valid. PLA")
#define MSG_UBL_VALIDATE_ABS_MESH           _UxGT("Netz valid. ABS")
#define MSG_UBL_VALIDATE_CUSTOM_MESH        _UxGT("Eig. Netz valid.")
#define MSG_UBL_CONTINUE_MESH               _UxGT("Netzerst. forts.")
#define MSG_UBL_MESH_LEVELING               _UxGT("Netz-Nivell.")
...
#define MSG_UBL_FILLIN_AMOUNT               _UxGT("Füllung: Menge")
...
#define MSG_LED_PRESETS                     _UxGT("Einstellungen")
#define MSG_SET_LEDS_RED                    _UxGT("Rt")
#define MSG_SET_LEDS_ORANGE                 _UxGT("Or")
#define MSG_SET_LEDS_YELLOW                 _UxGT("Ge")
#define MSG_SET_LEDS_GREEN                  _UxGT("Gr")
#define MSG_SET_LEDS_BLUE                   _UxGT("Bl")
#define MSG_SET_LEDS_INDIGO                 _UxGT("In")
#define MSG_SET_LEDS_VIOLET                 _UxGT("Vi")
#define MSG_SET_LEDS_WHITE                  _UxGT("We")
#define MSG_SET_LEDS_DEFAULT                _UxGT("Stand.")
#define MSG_CUSTOM_LEDS                     _UxGT("Benutzerdef.")
#define MSG_INTENSITY_R                     _UxGT("Int. R")
#define MSG_INTENSITY_G                     _UxGT("Int. G")
#define MSG_INTENSITY_B                     _UxGT("Int. B")
#define MSG_INTENSITY_W                     _UxGT("Int. W")
#define MSG_LED_BRIGHTNESS                  _UxGT("Hellig.")
...
#define MSG_EXTRA_FAN_SPEED                 _UxGT("Geschw. 2. Lüfter")
...
#define MSG_TEMPERATURE                     _UxGT("Temp.")
...
#define MSG_CONTRAST                        _UxGT("Kontrast")
...
#define MSG_INIT_EEPROM                     _UxGT("Werkseinst.")
#define MSG_REFRESH                         _UxGT("Aktualisieren")
#define MSG_WATCH                           _UxGT("Info")
#define MSG_PREPARE                         _UxGT("Vorbereitung")
#define MSG_TUNE                            _UxGT("Justierung")
#define MSG_PAUSE_PRINT                     _UxGT("pausieren")
#define MSG_RESUME_PRINT                    _UxGT("fortsetzen")
#define MSG_STOP_PRINT                      _UxGT("Druck abbrechen")
#define MSG_POWER_LOSS_RECOVERY             _UxGT("Wiederh. n. Stroma.")
#define MSG_CARD_MENU                       _UxGT("Druck v. Karte")
#define MSG_NO_CARD                         _UxGT("Keine Karte")
#define MSG_DWELL                           _UxGT("Warten...")
#define MSG_USERWAIT                        _UxGT("Klick zum Fortsetzen")
#define MSG_PRINT_PAUSED                    _UxGT("pausiert...")
#define MSG_PRINTING                        _UxGT("Druckt...")
#define MSG_PRINT_ABORTED                   _UxGT("abgebrochen")
#define MSG_NO_MOVE                         _UxGT("Motoren an")
...
#define MSG_FILAMENTCHANGE                  _UxGT("Fil. wechseln")
#define MSG_FILAMENTLOAD                    _UxGT("Fil. laden")
#define MSG_FILAMENTUNLOAD                  _UxGT("Fil. entladen")
#define MSG_FILAMENTUNLOAD_ALL              _UxGT("Alles entladen")
#define MSG_INIT_SDCARD                     _UxGT("Karte initialisi.")  // Manually initialize the SD-card via user interface
#define MSG_CNG_SDCARD                      _UxGT("Karte getauscht") // SD-card changed by user. For machines with no autocarddetect. Both send "M21"
...
#define MSG_BLTOUCH_DEPLOY                  _UxGT("BLTouch runter")
#define MSG_BLTOUCH_STOW                    _UxGT("BLTouch hoch")
...
#define MSG_DELTA_AUTO_CALIBRATE            _UxGT("Autokalibrierung")
...
#define MSG_INFO_STATS_MENU                 _UxGT("Statistik")
...
#define MSG_DRIVE_STRENGTH                  _UxGT("Leistung")
